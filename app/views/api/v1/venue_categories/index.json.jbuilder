json.venue_categories do 
	json.array! @venue_categories do |venue_category|
		json.extract! venue_category, :id, :name, :name_arm, :name_ru, :original_image_url, :thumb_image_url, :position
	end
end
...
json.venues do
	json.array!(@venues) do |venue|
		...
		:description_arm, :description_ru, :longitude, :latitude, :original_photo_url, :medium_photo_url, :thumb_photo_url
...
json.events do 
	json.array!(@events) do |event|
		json.extract! event, :id, :name, :name_arm, :name_ru, :description, :description_arm, :description_ru, :time, :original_photo_url, :medium_photo_url, :thumb_photo_url
